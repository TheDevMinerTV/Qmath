...
static double E = 2.7182818284590452; 
...
double qmath::abs(const double in)
{
	union doutoint
	{
		double asDou;
...
float qmath::abs(const float in)
{
	union flotoint
	{
		float asFlo;
...
long long qmath::abs(const long int in)
{
	union doutoint
	{
		double asDou;
...
double qmath::frexp(const double in1, int * in2)
{
...
double qmath::frexp(const double in1, short * in2)
{
	*in2 = ((0x7ff0000000000000 & (*(long long *) &in1)) >> 52) - 1023;
	return 2.2204460492503131e-16 * (0x000fffffffffffff & (*(long long *) &in1)) + 1;
}//Returns the mantissa and exponent of the given double.

float qmath::frexp(const float in1, int * in2)
{
...
float qmath::frexp(const float in1, short * in2)
{
	*in2 = ((0x7F800000 & (*(long *) &in1)) >> 23) - 127;
	return 1.192092896e-7f * (0x000fffff & (*(long *) &in1)) + 1;
}//Returns the mantissa and the exponent of the given float.
...
double qmath::sin(const double in)
{
...
float qmath::sin(const float in)
{
	//Forces `in` to be between -Pi and Pi and then divides it by 8.
...
double qmath::qsin(const double in)
{
...
float qmath::qsin(const float in)
{
	//Forces the given angle to be between -Pi and Pi and then divides it by 8
	const float ang = 0.125f * in - 0.78539816339744831f * ((int) (0.15915494309189534f * in + 0.39269908169872415f)) - 0.19634954084936208f;
	const float ang2 = ang * ang; //ang^2
...
double qmath::cos(const double in)
{
...
float qmath::cos(const float in)
{
...
//~45% faster than std::cos
double qmath::qcos(const double in)
{
	//Forces the given angle to be between -Pi and Pi and then divides it by 8
	const double ang = 0.125 * in - 0.78539816339744831 * ((int) (0.15915494309189534 * in + 0.39269908169872415));
	const double ang2 = ang * ang; //ang^2
...
float qmath::qcos(const float in)
{
	//Forces the given angle to be between -Pi and Pi and then divides it by 8
	const float ang = 0.125f * in - 0.78539816339744831f * ((int) (0.15915494309189534f * in + 0.39269908169872415f));
	const float ang2 = ang * ang; //ang^2
...
double qmath::tan(const double in)
{
	const double ang =
...
float qmath::tan(const float in)
{
...
double qmath::qtan(const double in)
{
	const double ang =
...
//~25% faster than std::tan
double qmath::cot(const double in)
{
	const double ang =
		-0.0625 * in + 0.19634954084936208 * ((int) (0.31830988618379067 * (in + 1.5707963267948966)));
	const double ang1 = ang * ang;
...
//~35% faster than std::tan
float qmath::fcot(const float in)
{
	const float ang = -0.0625f * in + 0.19634954084936208f * ((int) (0.31830988618379067f * (in + 1.5707963267948966f)));
	const float ang1 = ang * ang;
	const float ang2 = ang1 * ang1;
...
double qmath::qcot(const double in)
{
	const double ang =
		-0.125 * in + 0.39269908169872415 * ((int) (0.31830988618379067 * (in + 1.5707963267948966)));
	const double ang1 = ang * ang;
...
double qmath::log(const double in)
{
...
double qmath::qlog(const double in)
{
	const int exp = ((0x7ff0000000000000 & (*(long long *) &in)) >> 52) - 1023;
	const double base1 = 0.5 - 2.2204460492503131e-16 * (0x000fffffffffffff & (*(long long *) &in));
...
////Slower, rework
double qmath::sqrt(const double in)
{
...
////Also slower
double qmath::qsqrt(const double in)
{
	const double exp = 0.5 * ((0x7ff0000000000000 & (*(long long *) &in)) >> 52) - 511.5;
	const double base1 = 2.2204460492503131e-16 * (0x000fffffffffffff & (*(long long *) &in)) - 0.5;
...
double qmath::exp(const double in)
{
...
//~65% faster than std::exp
float qmath::exp(const float in)
{
...
double qmath::cosh(const double in)
{
	const double base1 = (in - (int) in);
	const double base2 = base1 * base1;
	const double base4 = base2 * base2;
...
//~90% faster than std::cosh
float qmath::cosh(const float in)
{
	const float base1 = (in - (int) in);
	const float base2 = base1 * base1;
	const float base4 = base2 * base2;
...
double qmath::sech(const double in)
{
	const double base1 = (in - (int) in);
	const double base2 = base1 * base1;
	const double base4 = base2 * base2;
...
//~90% faster than std::sinh
float qmath::sech(const float in)
{
	const float base1 = (in - (int) in);
	const float base2 = base1 * base1;
	const float base4 = base2 * base2;
...
//~90% faster than std::sinh
double qmath::sinh(const double in)
{
	const double base1 = (in - (int) in);
	const double base2 = base1 * base1;
	const double base4 = base2 * base2;
...
//~90% faster than std::sinh
float qmath::sinh(const float in)
{
	const float base1 = (in - (int) in);
	const float base2 = base1 * base1;
	const float base4 = base2 * base2;
...
//~90% faster than std::sinh
double qmath::csch(const double in)
{
	const double base1 = (in - (int) in);
	const double base2 = base1 * base1;
	const double base4 = base2 * base2;
...
//~90% faster than std::sinh
float qmath::csch(const float in)
{
	const float base1 = (in - (int) in);
	const float base2 = base1 * base1;
	const float base4 = base2 * base2;
...
////~10% slower, rework
double qmath::tanh(const double in)
{
	const double base1 = (in - (int) in);
	const double base2 = base1 * base1;
	const double base4 = base2 * base2;
...
////~10% slower, rework
double qmath::coth(const double in)
{
	const double base1 = (in - (int) in);
	const double base2 = base1 * base1;
	const double base4 = base2 * base2;
...
double qmath::nint(double(*fun)(double), double * var, double low, double up)
{
	double sum = 0;
...
float qmath::nint(float(*fun)(float), float * var, float low, float up)
{
	float sum = 0;
	int i;
...
double qmath::der4(double(*fun)(double), double * var, double point)
{
	*var = point;
...
float qmath::der4(float(*fun)(float), float * var, float point)
{
	*var = point;
...
double qmath::der6(double(*fun)(double), double * var, double point)
{
	*var = point;
...
float qmath::der6(float(*fun)(float), float * var, float point)
{
	*var = point;
...
double qmath::gnint(double(*fun)(), double * var, double low, double up)
{
	double sum = 0;
	const int length = (up - low) / QMATHDELTA;
	const double diff = up - low - length * QMATHDELTA;
...
float qmath::gnint(float(*fun)(), float * var, float low, float up)
{
	float sum = 0;
	const int length = (up - low) / QMATHDELTA;
...
double qmath::gder4(double(*fun)(), double * var, double point)
{
	double diff = 0;
...
float qmath::gder4(float(*fun)(), float * var, float point)
{
	float diff = 0;
	*var = point - QMATHDELTA;
...
double qmath::gder6(double(*fun)(), double * var, double point)
{
	double diff = 0;
	*var = point - QMATHDELTA;
...
float qmath::gder6(float(*fun)(), float * var, float point)
{
	float diff = 0;
	*var = point - QMATHDELTA;
